...
var _obj;
var OAuthIconMap = (_obj = {}, _define_property(_obj, types.OAuthName.VK, function(size) {
...
}), _define_property(_obj, types.OAuthName.OK, function(size) {
...
var getOAuthListTemplate = function(params) {
    return function(id) {
        var lang$1 = params.lang || types$1.Languages.RUS;
        ...
        var oauthListItems = params.oauthList.map(function(oauth) {
            var singleButtonTextLang = lang$1 === types$1.Languages.RUS ? lang.singleButtonText[lang$1][oauth] : "".concat(lang.singleButtonText[lang$1].replace("{provider}", constants.OAuthNameText[oauth]));
...
exports.getOAuthListTemplate = getOAuthListTemplate;
