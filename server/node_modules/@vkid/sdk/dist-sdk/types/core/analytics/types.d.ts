export declare enum ProductionStatsEventTypes {
    TYPE_ACTION = "type_action"
}
export declare enum ProductionStatsTypeActions {
    TYPE_REGISTRATION_ITEM = "type_registration_item",
    TYPE_SAK_SESSION_EVENT_ITEM = "type_sak_sessions_event_item"
}
export declare enum ProductionStatsEventScreen {
    NOWHERE = "nowhere",
...
export type RegistrationStatsEventTypes = 'iframe_loading_failed' | 'no_session_found' | 'onetap_button_no_user_show' | 'onetap_button_no_user_tap' | 'screen_proceed' | 'no_user_button_show' | 'no_user_button_tap' | 'multibranding_oauth_added' | 'vk_button_show' | 'ok_button_show' | 'mail_button_show' | 'vk_button_tap' | 'ok_button_tap' | 'mail_button_tap' | 'custom_auth_start' | 'community_follow_click' | 'community_follow_next_time_click' | 'community_follow_close' | 'community_follow_error_show' | 'community_follow_error_retry_click' | 'community_follow_error_cancel_click' | 'community_follow_error_close' | 'community_follow_success' | 'community_follow_modal_window_show';
